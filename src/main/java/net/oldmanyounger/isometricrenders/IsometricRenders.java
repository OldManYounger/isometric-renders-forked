 ...
 * {@link IsometricRendersClient} instead of being loaded directly here.</p>
 */
@Mod(IsometricRenders.MOD_ID)
public final class IsometricRenders {
    public static final String MOD_ID = "isometric_renders";
    public static final String LEGACY_TRANSLATION_ID = "isometric-renders";
