 ...
 * hyphenated key namespace, such as {@code gui.isometric-renders-forked.export}, even
 * though the NeoForge mod id is {@code isometric-renders-forked}.</p>
 */
public final class Translate {
    ...
    public static MutableComponent make(String key, Object... args) {
        return Component.translatable("message.isometric-renders-forked." + key, args);
    }

    // Creates a translated GUI component.
    public static MutableComponent gui(String key, Object... args) {
        return Component.translatable("gui.isometric-renders-forked." + key, args);
    }
